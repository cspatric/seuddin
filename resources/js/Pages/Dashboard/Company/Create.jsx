...
const Create = ({ auth, mustVerifyEmail, status }) => {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Criar empresa</h2>}>
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <header>
                        <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Criar empresa</h2>
                    </header>
                    <form onSubmit={submit} className="mt-6 space-y-6 max-w-xl">
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                <InputLabel htmlFor="tax_id" value="tax_id" />
                        ...
                        <div className="flex items-center gap-4">
                            <PrimaryButton disabled={processing}>Criar empresa</PrimaryButton>
