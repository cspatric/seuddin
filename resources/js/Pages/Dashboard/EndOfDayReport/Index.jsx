...
const Index = ({ auth, mustVerifyEmail, status, endOfDayReports }) => {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Todas as Solicitações de pagamento</h2>}>
